...
export class WhoisMetaService {
        ...
        _.each(attrs, (attr: IAttributeModel) => {
            ...
            if (!_.isUndefined(attrMeta)) {
                if (!_.isUndefined(attr.$$meta)) {
                    ...
                    enrichedAttrs.push(this.wrapMetaInAttribute(this, objectTypeName, attr.name, value, attr.comment, attr.link, attr["referenced-type"], attrMeta, undefined));
                }
            }
        });
    ...
    private wrapMetaInAttribute(self: any, objectTypeName: string, attrName: string, attrValue: string, attrComment: string,
