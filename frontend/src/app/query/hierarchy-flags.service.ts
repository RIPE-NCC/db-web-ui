...
export class HierarchyFlagsService {
    ...
    static readonly hierarchyFlagMap: IHierarchyFlag[] = [
        ...
        {id: 1, "short":"l", "long": "one-less", description: "Returns first level less specific inetnum, inet6num or route(6) objects, excluding exact matches."},
        ...
        {id: 3, "short":"m", "long": "one-more", description: "Returns first level more specific inetnum, inet6num or route(6) objects, excluding exact matches."},
        ...
        {id: 5, "short":"x", "long": "exact", description: "Requests that only an exact match on a prefix be performed. If no exact match is found no objects are returned."}
    ]
