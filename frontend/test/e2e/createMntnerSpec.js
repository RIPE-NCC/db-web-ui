 ...
 * Tests...
 */
describe('The CreateSelfMntnerComponent', function () {
    ...
    it('should redirect to create pair person and maintainer on click on link', function () {
    ...
    it('should suggest adminC after entering letters', function () {
        page.selectObjectType('mntner').click();
        page.btnNavigateToCreate.click();
    ...
    it('should show mntner after adminC was chosen', function () {
        page.selectObjectType('mntner').click();
        page.btnNavigateToCreate.click();
        expect(page.inpAdminCDropdown.isPresent()).toBeTruthy();
