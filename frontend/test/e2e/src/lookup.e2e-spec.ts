...
describe("The lookup page", () => {
    ...
    beforeEach(() => {
        page.navigateTo(browser.baseUrl + "lookup?source=RIPE&type=inetnum&key=193.0.0.0%20-%20193.0.0.63");
    });

    it("should be able to show an object", async () => {
        ...
        await page.scrollIntoCenteredView(page.byId("showEntireObjectInViewer"));
    ...
    it("should show not filtered object", async () => {
        await page.scrollIntoCenteredView(page.byId("showEntireObjectInViewer"));
        page.byId("showEntireObjectInViewer").click();
...
describe("The lookup page for organisation", () => {
    ...
    beforeEach(() => {
        page.navigateTo(browser.baseUrl + "lookup?source=RIPE&type=organisation&key=ORG-RIEN1-RIPE");
    });
...
describe("The lookup page with out of region object from ripe db", () => {
    ...
    beforeEach(() => {
        page.navigateTo(browser.baseUrl + "lookup?source=ripe&key=211.43.192.0%2F19AS9777&type=route");
    });
