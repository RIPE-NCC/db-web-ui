...
module.exports = {
    ...
    inpAdminCDropdownOptions: element(by.id('createForm'))
        .element(by.css("[name^='adminCDropdown']"))
        .element(by.css('.ng-dropdown-panel-items'))
        .all(by.css('.ng-option'))
        .first(),
    ...
    btnAddAttribute: element(by.id('createForm')).element(by.css('.attr-0')).element(by.css('.fal.fa-plus')),
    btn2ndAddAttribute: element(by.id('createForm')).element(by.css('.attr-1')).element(by.css('.fal.fa-plus')),
    ...
    ripeDatabaseQueryMenuItems: element
        .all(by.css_sr('app-nav-bar::sr #menu menu-item.top-level'))
        .get(3)
        .all(by.css_sr('::sr menu-item'))
        .get(0)
        .element(by.css_sr('::sr #title-query')),
    ...
    myResourcesActiveTabRows: element(by.css('.my-resources'))
        .element(by.id('ipv4-ipv6-asn-panes'))
        .element(by.css('.tab-pane.active'))
        .all(by.css('resource-item')),
    tabsMySponsoredResources: element(by.css('.my-resources')).element(by.css('.resources-sponsored-tabs')),
    tabsMySponsoredResourcesActiveLabel: element(by.css('.my-resources'))
        .element(by.css('.resources-sponsored-tabs'))
        .element(by.css('.nav-tabs'))
        .element(by.css('.nav-item .active')),
    ...
    woeBtnAddAttribute: element(by.css('whois-object-editor')).all(by.css('.fal.fa-plus')).first(),
    ...
    errorMessage: element(by.css_sr('app-banner::sr .app-banner.level-alarm')),
    ...
    hierarchyDCheckBox: element(by.id('hierarchyD')),
    hierarchyDCheckBoxInput: element(by.id('hierarchyD')).element(by.css('.mat-checkbox-input')),
    ...
    btnSubmitQuery: element(by.name('searchform')).element(by.css('button .fa-search')),
    btnShare: element(by.name('searchform')).element(by.css("button[mattooltip='Share Panel']")),
    noResultsMsgPanel: element(by.id('resultsSection')).element(by.css('.no-result-msg')),
    btnApplyFilters: element(by.id('applyFilters')),
    btnResetFilters: element(by.id('resetFilters')),
    linksToXmlJSON: element(by.id('searchSection')).element(by.css('.perm-xml-json-resultlinks')).all(by.css('a')),
    permLink: element(by.css('.perm-xml-json-resultlinks')).element(by.id('mat-input-1')),
    btnCopyPermLink: element(by.css('.perm-xml-json-resultlinks')).element(by.css('button')),
    ...
    btnAddAnAttribute: function (attribute) {
        return attribute.element(by.xpath('../../..')).element(by.css('.fal.fa-plus'));
    },
    ...
    btnEditAnAttribute: function (attribute) {
        return attribute.element(by.xpath('..')).element(by.css('.fal.fa-pencil'));
    },
