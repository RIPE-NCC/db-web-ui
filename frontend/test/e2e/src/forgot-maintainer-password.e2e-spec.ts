...
describe('Forgot Maintainer Password', () => {
    beforeEach(() => {
        page.navigateTo(browser.baseUrl + 'fmp/change-auth?mntnerKey=TEST-MNT&voluntary=true');
    });
    ...
    it('should validate the form', async () => {
        await page.scrollIntoCenteredView(page.fmpNext);
        page.fmpNext.click();
    ...
    it('should go to next page, and generate PDF link', async () => {
        await page.scrollIntoCenteredView(page.fmpNext);
        ...
        expect(linkToGeneratedPdf.getAttribute('href')).toContain(
            'eyJlbWFpbCI6InBlcnNvbkByaXBlLm5ldCIsIm1udG5lcktleSI6IlRFU1QtTU5UIiwicmVhc29uIjoianVzdCBiZWNhdXNlIiwidm9sdW50YXJ5Ijp0cnVlfQ==',
        );
    });
});
