...
describe('dbWebApp: FullTextResponseService', function () {

    var FullTextResponseService;

    beforeEach(module('dbWebApp'));

    beforeEach(inject(function (_FullTextResponseService_) {
        FullTextResponseService = _FullTextResponseService_;
    }));


    it('should be able to parse an empty Solr response', function () {
    ...
    it('should be able to parse a Solr response', function () {
        var result = FullTextResponseService.parseResponse(fts_193000);
    ...
    it('should be able to parse a paged response', function () {
    ...
    it('should fail gracefully if highlighting is not present', function () {
        var result;
    ...
    it('should not show summaries if facets are not present', function () {
        var data = fts_193000;
