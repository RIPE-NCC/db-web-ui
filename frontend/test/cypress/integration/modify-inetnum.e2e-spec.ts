...
describe('Modifying an inetnum', () => {
    ...
    describe('which has ASSIGNED PA status', () => {
        ...
        it('which is an end user assignment should show delete btn', () => {
            webupdatesPage.visit('modify/RIPE/inetnum/91.208.34.0%20-%2091.208.34.255').expectDisabledDelete(false);
        });
        ...
        it('which is an end user assignment should show delete btn in text editor', () => {
            webupdatesPage
                .visit('modify/RIPE/inetnum/91.208.34.0%20-%2091.208.34.255')
                .clickEditInTextArea()
                .expectTextupdatePage('inetnum/91.208.34.0%20-%2091.208.34.255')
