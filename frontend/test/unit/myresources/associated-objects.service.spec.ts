...
describe("AssociatedObjectsService", () => {
    ...
    describe("for route", () => {
        ...
        it("should call API for associated route objects of inetnum", (done) => {
            associatedObjectsService.getAssociatedObjects(
                "route",
                "185.162.88.0%20-%20185.162.91.255",
                "inetnum", 0, "")
                .subscribe((res: any) => {
            ...
            const req = httpMock.expectOne({method: "GET", url: "api/whois-internal/api/resources/inetnum/185.162.88.0%20-%20185.162.91.255/associated-route-objects.json?filter=&page=0"});
        ...
        it("should call API for associated route objects of autnum", (done) => {
            ...
            const req = httpMock.expectOne({method: "GET", url: "api/whois-internal/api/resources/aut-num/AS44569/associated-route-objects.json?filter=&page=0"});
            expect(req.request.method).toBe("GET");
            req.flush({resp: "lol"});
        });
    });
    ...
    describe("for domain", () => {
        it("should call API for associated domain objects of inet6num", (done) => {
            ...
            const req = httpMock.expectOne({method: "GET", url: "api/whois-internal/api/resources/inet6num/2001:67c:2334::/48/associated-domain-objects.json?filter=&page=0"});
            expect(req.request.method).toBe("GET");
            req.flush({resp: "lol"});
        });
        ...
        it("should fail calling API for associated domain objects of aut-num", () => {
            ...
            const req = httpMock.expectOne({method: "GET", url: "api/whois-internal/api/resources/aut-num/AS44569/associated-domain-objects.json?filter=&page=0"});
            expect(req.request.method).toBe("GET");
