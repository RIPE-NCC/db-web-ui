...
describe('IpUsageComponent', () => {
    ...
    it('should calculate free space and percentages for inetnum', () => {
        ...
        component.ngOnChanges({
            type: new SimpleChange(undefined, 'inetnum', true),
            usage: new SimpleChange(undefined, '{total: 8192, used: 4107, blockSize: 32}', true),
        });
    ...
    it('should calculate free space and percentages for inet6num', () => {
        ...
        component.ngOnChanges({
            ...
            usage: new SimpleChange(undefined, '{total: 65536, used: 523, blockSize: 48}', true),
        });
        fixture.detectChanges();
