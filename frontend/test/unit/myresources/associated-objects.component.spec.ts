...
describe('AssociatedObjectsComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            providers: [AssociatedObjectsService, PropertiesService],
        });
    ...
    describe('for route', () => {
        it('should instantiate route tables', async () => {
            ...
            expect(req.request.urlWithParams).toBe(
                'api/whois-internal/api/resources/inetnum/185.162.88.0 - 185.162.91.255/associated-route-objects.json?filter=&page=0',
            );
    ...
    describe('for domain', () => {
        it('should instantiate domain tables', async () => {
            ...
            expect(req.request.urlWithParams).toBe(
                'api/whois-internal/api/resources/inetnum/185.162.88.0 - 185.162.91.255/associated-domain-objects.json?filter=&page=0',
            );
