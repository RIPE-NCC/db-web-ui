...
describe("FullTextSearchService", () => {
    ...
    it("should be able to encode query text", (done) => {
        ...
        fullTextSearchService.doSearch(query, start, advanced, advancedMode, searchObjects, searchAttributes)
    ...
    it("should be able to encode various", (done) => {
        ...
        const req = httpMock.expectOne({method: "GET", url: "api/rest/fulltextsearch/select?facet=true&format=xml&hl=true&q=(remarks:(ops4%5C-ripe))%20AND%20(object-type:inetnum%20OR%20object-type:mntner)&start=0&wt=json"});
        expect(req.request.method).toBe("GET");
        req.flush("response");
    });
    ...
    it("should be able to encode advanced all options", (done) => {
        ...
        const req = httpMock.expectOne({method: "GET", url: "api/rest/fulltextsearch/select?facet=true&format=xml&hl=true&q=(ops4%5C-ripe%20AND%20etch%5C-mnt)%20AND%20(object-type:inetnum%20OR%20object-type:mntner)&start=0&wt=json"});
        expect(req.request.method).toBe("GET");
        req.flush("response");
    });
    ...
    it("should be able to encode advanced any options", (done) => {
        ...
        const req = httpMock.expectOne({method: "GET", url: "api/rest/fulltextsearch/select?facet=true&format=xml&hl=true&q=(ops4%5C-ripe%20OR%20etch%5C-mnt)%20AND%20(object-type:inetnum%20OR%20object-type:mntner)&start=0&wt=json"});
        expect(req.request.method).toBe("GET");
        req.flush("response");
    });
    ...
    it("should be able to encode advanced exact options", (done) => {
        ...
        const req = httpMock.expectOne({method: "GET", url: "api/rest/fulltextsearch/select?facet=true&format=xml&hl=true&q=(remarks:(%22ops4%5C-ripe%20etch%5C-mnt%22)%20OR%20country:(%22ops4%5C-ripe%20etch%5C-mnt%22))%20AND%20(object-type:inetnum%20OR%20object-type:mntner)&start=0&wt=json"});
        expect(req.request.method).toBe("GET");
        req.flush("response");
    });
});
