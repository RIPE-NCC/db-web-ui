...
import {QueryComponent} from "../../../app/ng/query/query.component";
import {QueryService} from "../../../app/ng/query/query.service";
import {QueryParametersService} from "../../../app/ng/query/query-parameters.service";
import {CoreModule} from "../../../app/ng/core/core.module";
import {LookupComponent} from "../../../app/ng/query/lookup.component";
import {TemplateComponent} from "../../../app/ng/query/template-component/template.component";
...
import {IWhoisResponseModel} from "../../../app/ng/shared/whois-response-type.model";
...
describe("QueryComponent", () => {
    ...
    describe("with a failed query", () => {
        ...
        it("should show error messages", () => {
            ...
            expect(component.formatError(component.errorMessages[1])).toEqual("So Goodbye, Yellow Brick Road");
            expect(component.formatError(component.errorMessages[2])).toEqual("Goodbye, cruel world!");
            expect(component.formatError(component.errorMessages[3])).toEqual("Broken message");
            expect(queryService.searchWhoisObjects).toHaveBeenCalledTimes(1);
        });
    });
    ...
    describe("with a --template query", () => {
        ...
        it("should show error messages", () => {
            ...
            expect(component.formatError(component.errorMessages[0])).toEqual("Unknown object type \"zzz\".");
        });
    });
});
