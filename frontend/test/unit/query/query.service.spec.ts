...
describe("QueryService", () => {
    ...
    it("should generate a link for a text search with options", () => {
        ...
        expect(queryService.buildPermalink(qp)).toEqual("searchtext=yorkshire&inverse=mnt-ref;mnt-by&types=mntner;as-set&" +
            "hierarchyFlag=one-less&dflag=true&rflag=true&source=TEST&bflag=true");
        expect(queryService.buildQueryStringForLink(qp)).toEqual("query-string=yorkshire&inverse-attribute=mnt-ref&" +
    ...
    it("should be able to run queries and accumulate results", (done) => {
        ...
        queryService.searchWhoisObjects(qp, 0)
