export class Labels {
    // public static flagNoContractText: string = "No contract";
    ...
    public static MSG_RIPE_T_AND_C_SUBMITLINK_TEXT = "By submitting this form you explicitly express your agreement with the <a href='https://www.ripe.net/db/support/db-terms-conditions.html' target='_blank'>RIPE Database Terms and Conditions</a>";
