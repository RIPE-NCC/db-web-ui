...
.controller('CreateController', ['$scope', '$stateParams', '$state', '$resource', 'WhoisMetaService', 'WhoisRestService',
function ($scope, $stateParams, $state, $resource, WhoisMetaService, WhoisRestService) {
