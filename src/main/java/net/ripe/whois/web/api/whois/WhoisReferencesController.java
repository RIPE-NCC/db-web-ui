...
public class WhoisReferencesController extends ApiController {
    ...
    public ResponseEntity<WhoisResources>  delete(@PathVariable String source, @PathVariable String objectType,
        @PathVariable String name, @RequestParam("reason") String reason,  @RequestParam("password") String password, @RequestHeader final HttpHeaders headers) throws URISyntaxException {
