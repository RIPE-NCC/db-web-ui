...
describe('webupdates', function () {
    ...
    fit('should show "force delete" for an inetnum if NOT allocated by RIPE', function () {
    ...
    fit('should NOT show "force delete" for an inet6num if allocated by RIPE', function () {
