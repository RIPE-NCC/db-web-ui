    ...
    angular.module('dbWebAppE2E', ['dbWebApp', 'ngMockE2E'])
        .run(function ($httpBackend) {
            ...
            var mockGet = {
                ...
                AS9191: {
                    req: 'api/whois/ripe/aut-num/AS9191?unfiltered=true',
                    resp: {
                        data: {
                            "objects": {
                                "object": [{
                ...
                inetnumAutoComplete2: {
                    req: 'api/whois/autocomplete?extended=true&field=inetnum&query=213.159.160.0+-+213.159.190.255',
                    resp: {
                        data: []
                    }
                },
                ...
                inetnumParent2: {
                    req: 'api/whois/search?flags=lr&ignore404=true&query-string=213.159.160.0+-+213.159.190.255&type-filter=inetnum',
                    resp: {
                        data: {
                            "service": {
                                "name": "search"
                ...
                inet6numAutoComplete: {
                    req: 'api/whois/autocomplete?extended=true&field=inet6num&query=2001:888:2000::%2F38',
                    resp: {
                        data: []
                    }
                },
                ...
                inet6numAllocation: {
                    req: 'api/whois/RIPE/inet6num/2001:999:2000::%2F36?unfiltered=true',
                    resp: {
                        data: {
                            "service": {
                                "name": "search"
                ...
                inet6numAssignment: {
                    req: 'api/whois/RIPE/inet6num/2001:998:2000::%2F36?unfiltered=true',
                    resp: {
                        data: {
                            "service": {
                                "name": "search"
                ...
                autoCompleteAuthAs9191: {
                    req: 'api/whois/autocomplete?attribute=auth&extended=true&field=mntner&query=NEWNET-MNT',
                    resp: {
                        data: [{
                            "key": "NEWNET-MNT",
                            "type": "mntner",
