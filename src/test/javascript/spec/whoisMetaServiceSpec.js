...
describe('dbWebApp: WhoisMetaService', function () {
    ...
    it('should enrich attributes with meta attributes for a given type', function(){
        ...
        expect($whoisMetaService.enrichAttributesWithMetaInfo('type1', attrs)).toEqual([
            { name: 'mandatory1', value:'mandatory1value', $$meta: {$$idx: undefined, $$mandatory:true,  $$multiple:false, $$primaryKey: undefined, $$description:'A', $$syntax:'S A', $$refs:[], $$allowedValues: undefined}},
            { name: 'optional1',  value:'optional1value',  $$meta: {$$idx: undefined, $$mandatory:false, $$multiple:true,  $$primaryKey: undefined, $$description:'B', $$syntax:'S B', $$refs:['b'], $$allowedValues: undefined}}
        ])
    });
    ...
    it('should return all attributes for a given type', function(){
        ...
        expect($whoisMetaService.getAllAttributesOnObjectType('type1')).toEqual([
            { name:'mandatory1', value: undefined, $$meta: {$$idx:0, $$mandatory:true, $$multiple:false,  $$primaryKey: undefined, $$description:'A', $$syntax:'S A', $$refs:[], $$allowedValues: undefined}},
            { name:'optional1',  value: undefined, $$meta: {$$idx:1, $$mandatory:false, $$multiple:true,  $$primaryKey: undefined, $$description:'B', $$syntax:'S B', $$refs:[], $$allowedValues: undefined}}
        ])
    });
        ...
        expect($whoisMetaService.getMandatoryAttributesOnObjectType('type1')).toEqual([
            {
                ...
                value: undefined,
                $$meta: {
                    $$idx:0,$$mandatory:true, $$multiple:false, $$primaryKey: undefined, $$description: 'A', $$syntax:'S A', $$refs:[], $$allowedValues: undefined
                }
            }
        ])
    });
