...
describe('webUpdates: CreatePersonMntnerPairController', function () {
    ...
    it('should pre-populate and submit ok', function () {
        ...
        expect($scope.mntnerAttributes.getSingleAttributeOnName('descr').value).toEqual('Startup mntner');
        ...
        $httpBackend.expectPOST('api/references/RIPE').respond(function(method,url) {
