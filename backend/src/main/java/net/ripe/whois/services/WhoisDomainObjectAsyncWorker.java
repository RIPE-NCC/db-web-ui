...
@Component
public class WhoisDomainObjectAsyncWorker {

    private final RestTemplate restTemplate;
    private final String restApiUrl;
    private static final Logger LOGGER = LoggerFactory.getLogger(WhoisDomainObjectAsyncWorker.class);

    @Autowired
    public WhoisDomainObjectAsyncWorker(final RestTemplate restTemplate,
    ...
    @Async
    protected Future<ResponseEntity<String>> createDomainObjectsAsync(
            final String source,
