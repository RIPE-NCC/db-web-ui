...
public class CrowdClient {
    ...
    static class CrowdResponse {
        ...
        public String getUUID() {
            final CrowdAttribute uuid = Iterables.find(attributes, new Predicate<CrowdAttribute>() {
                @Override public boolean apply(final CrowdAttribute input) {
    ...
    // TODO: [ES] merge into whois-commons
    ...
    static class CrowdSession {
        ...
        public CrowdSession(final CrowdUser user, final String token, final String expiryDate, final String displayName) {
            this.user = user;
            this.token = token;
